...
import { getResidentById, updateResident, calculateAge } from '../utils/storage';
...
export function EditResident() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!id || !formData.birthDate) return;
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">Edit Resident</h2>
        <p className="text-gray-600">Update resident information</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              <input
                type="checkbox"
                name="householdHead"
                checked={formData.householdHead || false}
                onChange={handleChange}
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                name="voterStatus"
                value={formData.voterStatus || 'Not Registered'}
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center">
                <input
                  type="checkbox"
                  name="pwdStatus"
                  checked={formData.pwdStatus || false}
                  onChange={handleChange}
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  name="seniorCitizen"
                  checked={formData.seniorCitizen || false}
                  onChange={handleChange}
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  name="indigent"
                  checked={formData.indigent || false}
                  onChange={handleChange}
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
